    ...
    return (
        <>
            ...
            <div class="container">
                ...
                <div class="col-lg-6">
                    <h1 class="h2 text-uppercase mb-0">Tiến hành đặt hàng</h1>
                </div>
                <div class="col-lg-6 text-lg-end">
                    <nav aria-label="breadcrumb">
                    <ol class="breadcrumb justify-content-lg-end mb-0 px-0 bg-light">
                        <li class="breadcrumb-item"><Link class="text-dark" to="/">Trang chủ</Link></li>
                        <li class="breadcrumb-item"><Link class="text-dark" to="/gio-hang">Giỏ hàng</Link></li>
            ...
            <section class="py-5">
            {/* <!-- BILLING ADDRESS--> */}
            <h2 class="h5 text-uppercase mb-4">Thông tin hóa đơn</h2>
            <div class="row">
                <div class="col-lg-8">
                <form action="#">
                    <div class="row gy-3">
                    ...
                    <div class="col-lg-6 form-group">
                        <label class="form-label text-sm text-uppercase" for="country">Khu vực</label>
                        <select class="country" id="country" data-customclass="form-control form-control-lg rounded-0">
                        <option value selected>Chọn khu vực của bạn</option>
                        {/* <option value selected>Hồ Chí Minh</option> */}
                        {/* <option value>Tỉnh thành khácy</option> */}
                        </select>
                    </div>
                    <div class="col-lg-6">
                    ...
                    <div class="col-lg-12">
                        <label class="form-label text-sm text-uppercase" for="address">Địa chỉ giao hàng </label>
                        <input class="form-control form-control-lg" type="text" id="address" placeholder="Mời nhập chi tiết thông tin địa chỉ" />
                    </div>
                    {/* <div class="col-lg-12">
                ...
                <div class="card border-0 rounded-0 p-lg-4 bg-light">
                    <div class="card-body">
                    <h5 class="text-uppercase mb-4">Đơn hàng của bạn gồm <span>(5)</span></h5>
