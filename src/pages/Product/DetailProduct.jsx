        ...
        <section className="py-4">
            ...
            <div className="container">
                <div className="row mb-5">
                    ...
                    <BreadcrumbCustom item={categories} itemActive={subCategories.name}/>
                    {/* <!-- PRODUCT SLIDER--> */}
                    ...
                    <div  className="col-lg-5" id='san-pham'>
                        <h1 className="mb-4 mt-1" style={{fontFamily: "Roboto Medium",textTransform: "capitalize"}}>{product.name}</h1>
