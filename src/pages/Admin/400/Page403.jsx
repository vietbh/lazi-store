...
function Page403() {
  ...
  return (
    <React.Fragment>
      <div className="container-fluid position-relative bg-light m-0 pt-2">
        <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" data-name="Layer 1" viewBox="0 0 650 512" id="security-error">
          ...
          <line x1="125.247" x2="155.568" y1="264.724" y2="264.724" fill="none" stroke="#b9d4db" strokeMiterlimit="10" strokeWidth="3"></line>
          <line x1="125.247" x2="155.568" y1="273.463" y2="273.463" fill="none" stroke="#b9d4db" strokeMiterlimit="10" strokeWidth="3"></line>
          <line x1="125.247" x2="155.568" y1="282.202" y2="282.202" fill="none" stroke="#b9d4db" strokeMiterlimit="10" strokeWidth="3"></line>
          <line x1="493.195" x2="523.515" y1="297.862" y2="297.862" fill="none" stroke="#b9d4db" strokeMiterlimit="10" strokeWidth="3"></line>
          <line x1="493.195" x2="523.515" y1="306.601" y2="306.601" fill="none" stroke="#b9d4db" strokeMiterlimit="10" strokeWidth="3"></line>
          <line x1="493.195" x2="523.515" y1="315.341" y2="315.341" fill="none" stroke="#b9d4db" strokeMiterlimit="10" strokeWidth="3"></line>
        ...
        <div className="position-absolute top-0 start-50 translate-middle-x">
          <h2 className="fs-4 fw-bold text-center text-dark ">
            <span className="fw-bolder mb-3 p-0" style={{fontSize:'11rem'}}>404</span> 
          </h2>
        </div>
        <div className="position-absolute bottom-0 start-50 translate-middle-x">
          <h2 className="fs-3 fw-bold text-center text-dark">
            <p className="p-0">
              <Link className="text-decoration-underline fs-4" to={"/"}>Trở lại trang chủ</Link>
              <br/>
